...
const ensureChild = child =>
  child !== void 0 && child !== null && typeof child.render === 'function'
    ? ensureChild(child.render())
    : child

const isForwardRef = Comp =>
  Comp.type !== void 0 && Comp.type.$$typeof === REACT_FORWARD_REF_TYPE // const isMemo = Comp =>
...
export default function reactTreeWalker(
  ...
  return new Promise((resolve, reject) => {
    ...
    async function recursive(currentElement, currentContext, newContext) {
      ...
      async function _ref(render, compInstance, elContext, childContext) {
        let result

        try {
          result = await visitor(
            currentElement,
            compInstance,
            newContext,
            elContext,
      ...
      if (currentElement.type !== void 0) {
        ...
        const visitCurrentElement = _ref
        ...
        if (
          ...
          if (isForwardRef(currentElement)) {
            ...
            instance.setState = newState => {
              ...
              instance.state = _extends({}, instance.state, newState)
            }
            ...
            if (Component.getDerivedStateFromProps) {
              ...
              if (result !== null) {
                instance.state = _extends({}, instance.state, result)
              }
            }

            const childContext =
              typeof instance.getChildContext === 'function'
                ? _extends({}, currentContext, instance.getChildContext())
                : currentContext
            let result
